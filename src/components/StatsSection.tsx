...
const stats = [
  { value: 10, label: 'OTQAZILGAN IMTIHONLAR', suffix: '+' },
  { value: 98, label: 'MUVAFFAQQIYAT KORSATKISHI', suffix: '%' },
  { value: 1, label: 'TALIM MUASSASALARI', suffix: '+' },
  { value: 24, label: 'QULLAB QUVVATLASH', suffix: '/7' },
];
